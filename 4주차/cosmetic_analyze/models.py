...
class Profile(models.Model):
    ...
    joined_at = models.ForeignKey(User, on_delete=models.CASCADE, db_column='date_joined',related_name='Profile_joindate')
...
class Cosmetic(models.Model):
    name = models.CharField(max_length=30)
    category_id = models.OneToOneField(Category,on_delete=models.CASCADE,related_name='Cosmetic_category')
